...
public class WatchList implements Bingeable<Watchable> {
	...
	private int aNext;
	private Watchable lastWatchedElement;
	...
	/**
	 * Callback method for the last watched element
	 * Actually I don't think the Observer pattern is needed for 1. because there is only one observer that would be the
	 * watchlist and many subjects
	 * @return
	 */
	public Watchable lastWatched(){
		...
		return lastWatchedElement;
	}

	public void setLastWatchedElement(Watchable pWatchable){
		this.lastWatchedElement = pWatchable;
	}
}
